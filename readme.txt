...
This work is done in the Coq Proof General (Version 4.4pre). We have used the Company-Coq extension [#Company-Coq] for the Proof General. The proofs are split into following files:
...
14. Erdos_Szeker.v: Contains the proof of the Erdős-Szekeres theorem on sequences.

 The files can be safely compiled in the given order. 